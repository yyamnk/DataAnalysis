...
2. 新規ローカルアカウントの作成
    ...
    - 具体的には，
        ...
        - サインアウトして，新規作成したアカウントでログインする
            - 新規アカウントでは，「OneDriveとの連携」や「Microsoftアカウントに切り替える」などMicrosoft関連のクラウド連携は行わないこと．
...
[![](https://img.youtube.com/vi/hOq1HbtwKcs&t=209s/0.jpg)](https://www.youtube.com/watch?v=hOq1HbtwKcs&t=209s)
